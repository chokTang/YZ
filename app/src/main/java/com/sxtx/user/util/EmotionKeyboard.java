...
public class EmotionKeyboard {
    ...
    private int getSupportSoftInputHeight() {
        ...
        if (softInputHeight < 0) {
            LogUtil.loge("EmotionKeyboard--Warning: value of softInputHeight is below zero!");
        }
        //存一份到本地
        if (softInputHeight > 0) {
    ...
    public int getKeyBoardHeight() {
        return sp.getInt(SHARE_PREFERENCE_SOFT_INPUT_HEIGHT, 743);
    ...
    private noticeListStatue statue;

    public interface noticeListStatue {
        void onNoticeListStatue();
    }

    public void setOnNoticeListStatueListener(noticeListStatue statue) {
        this.statue = statue;
    }
}
