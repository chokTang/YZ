...
package com.sxtx.user.util.zxing.android;
...
import com.sxtx.user.util.zxing.camera.CameraManager;
import com.sxtx.user.util.zxing.decode.DecodeThread;
import com.sxtx.user.util.zxing.view.ViewfinderResultPointCallback;
