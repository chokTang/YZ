package com.like.base.dialog.original;
...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog builder() {
        ...
        View view = LayoutInflater.from(context).inflate(
                R.layout.dialog_actionsheet_layout, null);
    ...
    public ActionSheetDialog addSheetItem(String strItem,
        ...
        sheetItemList.add(new SheetItem(strItem, SheetItemColor.Default, listener));
        return this;
    }
    ...
    public enum SheetItemColor {
        ColorFirst("#333333"), ColorSecond("#666666"), ColorThree("#999999"),Default("#444444");
